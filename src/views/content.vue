<template>
    <div>
        ...
        <NewPlaceDialogue
            v-bind:showDialog="cleanCoords.length != 0"
            v-on:cancel="cleanCoords"
        />
        <PromptPlaceDeletion />

        <md-snackbar :md-active.sync="deleteStatus"
            >Place was deleted with success!</md-snackbar
        >
        <md-snackbar :md-active.sync="addStatus"
            >Place was added successfully</md-snackbar
        >
        <md-snackbar :md-active.sync="editStatus"
            >Place was edited successfully</md-snackbar
        >
    </div>
</template>
...
export default {
    ...
    updated() {},
    methods: {
        ...mapActions('places', ['getAllPlaces']),
        addplace(value) {
